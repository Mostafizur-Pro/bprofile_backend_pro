...
const getAllPaidVideos = catchAsync(
...
const createPaidVideo = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
const updatePaidVideo = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    connection.query(
      "UPDATE paid_video_post SET ? WHERE id = ?",
...
const deletePaidVideo = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const postId = req.params.id;

    connection.query(
      "DELETE FROM paid_video_post WHERE id = ?",
      [postId],
      (error: any, results: any, fields: any) => {
        if (error) {
