...
const getAllHallRoomData = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    config_1.connection.query("SELECT * FROM hall_room_post", (error, results, fields) => {
