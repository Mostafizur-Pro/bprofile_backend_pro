...
exports.paidImageController = void 0;
...
const getPaidImageById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const postId = req.params.id; // Assuming postId is passed as a route parameter
    // console.log("id", postId);
    config_1.connection.query("SELECT * FROM paid_image_post WHERE id = ?", [postId], (error, results, fields) => {
        if (error) {
            console.error("Error fetching post:", error);
            return res.status(http_status_1.default.INTERNAL_SERVER_ERROR).json({
                success: false,
...
const createPaidImage = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const updatePaidImage = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    config_1.connection.query("UPDATE paid_image_post SET ? WHERE id = ?", [updatedFields, postId], (error, results, fields) => {
        if (error) {
...
const deletePaidImage = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const postId = req.params.id;
    config_1.connection.query("DELETE FROM paid_image_post WHERE id = ?", [postId], (error, results, fields) => {
        if (error) {
